   ...
   return (
      <div className='fixed bottom-5 right-5 z-50 flex flex-col items-center gap-3'>
         <a
            ...
            className='flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_30px_rgba(0,0,0,0.25)] transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80'>
            <svg
               aria-hidden='true'
               viewBox='0 0 32 32'
         ...
         <button
            ...
            className='flex h-12 w-12 items-center justify-center rounded-full bg-slate-900 text-white shadow-[0_12px_30px_rgba(0,0,0,0.25)] transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80'>
            <svg
               aria-hidden='true'
               viewBox='0 0 24 24'
               className='h-5 w-5 fill-current'>
               <path d='M12 4.5 5.5 11l1.4 1.4L11 8.3V19.5h2V8.3l4.1 4.1L18.5 11 12 4.5z' />
            </svg>
